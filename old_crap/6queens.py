...
N_QUEENS = 6 # don't change this - the below code will NOT generalize
...
class Generation:
    ...
    def breed_all_combinations(self):
        ...
        for combo in itertools.combinations(self.dna, 2):            
            ...
            # create all 16 possible offsping of all possible combinations
            for i in range(1,17):
    ...
    def generate_baby_dna(self,mom_dna,dad_dna,method):
        ...
        """ No mutation here, just the method 1 to 16 as defined """
        
        # break parents into 3 chromosomes each
        ...
        # return DNA based on method - 16 possible combinations
        
        # option 1 - mom is gentically dominant
        # our dna splits  2/1 in favor of mom
        # 8 possible combinations based on order       
        
        # mom goes first
        if(method==1):
            return(cm1+cm2+cd1) # m 12 d 1
        elif(method==2):
            return(cm1+cm2+cd3) # m 12 d 3            
        elif(method==3):
            return(cm2+cm3+cd1) # m 23 d 1            
        elif(method==4):
            return(cm2+cm3+cd3) # m 23 d 3                        

        # dad goes first        
        elif(method==5):
            return(cd1+cm1+cm2) # d 1 m 12       
        elif(method==6):
            return(cd3+cm1+cm2) # d 3 m 12            
        elif(method==7):
            return(cd1+cm2+cm3) # d 1 m 23                        
        elif(method==8):
            return(cd3+cm2+cm3) # d 3 m 23                        
            
        # option 2 - dad is gentically dominant
        # our dna splits  2/1 in favor of dad
        # 8 possible combinations based on order   

        # mom goes first           
        elif(method==9):
            return(cm1+cd1+cd2) # m 1 d 12
        elif(method==10):
            return(cm3+cd1+cd2) # m 3 d 12            
        elif(method==11):
            return(cm1+cd2+cd3) # m 1 d 23
        elif(method==12):
            return(cm3+cd2+cd3) # m 3 d 23            
            
        # dad goes first
        elif(method==13):
            return(cd1+cd2+cm1) # d 12 m 1
        elif(method==14):
            return(cd1+cd2+cm3) # d 12 m 3            
        elif(method==15):
            return(cd2+cd3+cm1) # d 23 m 1
        elif(method==16):
            return(cd2+cd3+cm3) # d 23 m 3
